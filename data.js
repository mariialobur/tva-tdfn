...
export const CASES = [
  ...
  },
  {
    ...
    "given": [
      {
        "label": "Méthode de l’aliénateur",
        "note": "Méthode effective avant le transfert.",
        "tag": "Effective"
      },
      {
        "label": "Méthode du repreneur",
        "note": "Atelier Repris Sàrl applique les TDFN.",
        "tag": "TDFN"
      },
      {
        "label": "Affectation antérieure",
        "note": "100 % à une activité donnant droit à la déduction de l’impôt préalable.",
        "tag": "Documentée"
      },
      {
        "label": "Pièces disponibles",
        "note": "Factures d’origine, inventaire, date d’acquisition, affectation et valeurs résiduelles.",
        "tag": "Complet"
      }
    ],
    "checks": [
    ...
    "questions": [
      {
        ...
        "options": [
          "Oui",
          "Non, il faut d’abord qualifier les méthodes, l’affectation et la valeur résiduelle"
        ],
        "answer": 1,
      ...
      },
      {
        ...
        "options": [
          "Oui, sous réserve du calcul documenté",
          "Non, jamais sous TDFN"
        ],
        "answer": 0,
      ...
      },
      {
        ...
        "options": [
          "Oui",
          "Non, la méthode de l’aliénateur est sans importance"
        ],
        "answer": 0,
  ...
  },
  {
    ...
    "given": [
      {
        ...
        "amount": 30000,
        "note": "Produits agricoles provenant de la propre exploitation; montant de l’exercice.",
        "tag": "Art. 21 al. 2 ch. 26"
      },
      {
      ...
      {
        "label": "Qualification",
        "note": "Option valablement exercée pour l’exception admise dans ce cas.",
        "tag": "Prérequis vérifié"
      }
    ],
    "checks": [
    ...
    "questions": [
      ...
      },
      {
        ...
        "options": [
          "Oui, si les conditions de l’option sont remplies",
          "Non, jamais"
        ],
        "answer": 0,
      ...
      },
      {
        ...
        "options": [
          "Oui",
          "Non, elle figure seulement au ch. 205"
        ],
        "answer": 0,
  ...
  },
  {
    ...
    "given": [
      ...
      {
        "label": "TDFN confirmé",
        "note": "Conseil aux entreprises pour l’exercice.",
        "tag": "6,2 %"
      },
      {
        "label": "Correction déjà déterminée",
        "amount": 2000,
        "note": "Charge fiscale documentée à reporter au ch. 415 comme montant négatif.",
        "tag": "− CHF 2’000"
      }
    ],
    "checks": [
