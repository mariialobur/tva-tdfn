...
export const CASES = [
  ...
  },
  {
    ...
    description:'Depuis 2025, un changement entre méthode effective et TDFN peut entraîner une correction sur la valeur résiduelle.',conceptualNote:'Ce quiz compare deux décomptes distincts. Le ch. 415 figure dans le dernier décompte avant le passage aux TDFN; le ch. 410 figure uniquement dans le premier décompte selon la méthode effective après la sortie des TDFN. Le ch. 410 n’appartient donc pas à la vue TDFN affichée dans les autres cas.',mission:'Identifiez la direction de la correction, le moment de déclaration et le formulaire concerné.',
    ...
    given:[{label:'Effective → TDFN',note:'Correction au ch. 415 du dernier décompte avant le passage.',tag:'Dernier décompte'},{label:'TDFN → effective',note:'Déduction au ch. 410 du premier décompte sous méthode effective; rubrique absente du formulaire TDFN.',tag:'Formulaire effective'}],
    checks:['La valeur résiduelle doit être documentée.','Le sens de la correction dépend du changement de méthode.','Le ch. 410 appartient au décompte selon méthode effective, pas au décompte TDFN.'],legal:'Art. 37 LTVA · pratique AFC dès 2025 · Info TVA 12',sourceIds:['afc-main','info12'],
